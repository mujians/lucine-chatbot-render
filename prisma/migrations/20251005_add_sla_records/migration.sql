...
-- CreateEnum for SLA record status (different from legacy SLAStatus)
CREATE TYPE "SLARecordStatus" AS ENUM ('OK', 'WARNING', 'VIOLATED');

-- CreateTable SLAMonitoringRecord
...
-- AddForeignKey
ALTER TABLE "SLAMonitoringRecord" ADD CONSTRAINT "SLAMonitoringRecord_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "ChatSession"("sessionId") ON DELETE CASCADE ON UPDATE CASCADE;
