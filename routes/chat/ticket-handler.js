...
${conversationContext}
        ...
        // HOTFIX: Resume URL generation disabled until DB schema is deployed
        // const baseUrl = process.env.CHAT_WIDGET_URL || 'https://lucinedinatale.it';
        // const resumeUrl = `${baseUrl}?ticket=${ticket.resumeToken}`;
        const resumeUrl = null; // Temporary

        // HOTFIX: Update disabled until DB schema is deployed
